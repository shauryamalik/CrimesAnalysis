...
### Any parks causing particularly large amounts of trouble (amongst parks with non-zero crime occurence)?
```{r fig.height=4}
...
We see here a very distinct dependance of crime on the park size. We see that crime occurs almost exclusively in the large parks.
...
However, Manhattan and Brooklyn saw an increase in park crime rates till 2017, followed by a slkight increase in Manhattan and slight decrease in Brooklyn. Following this, the park crime occurrence has remained stable. 
